        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
          <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
            ...
            <span className="relative whitespace-nowrap text-blue-600">
              ...
              <span className="relative">Indonesia</span>
            </span>{' '}
            untuk semua kalangan
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
            Pusat baca dan belajar terbaik di Indonesia. Kami menyediakan akses mudah ke ribuan buku dan fasilitas belajar yang nyaman untuk semua.
          </p>
        </div>

      <section id="secondary-features" className="bg-slate-50 py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-x-8">
            ...
            <div className="rounded-3xl bg-white p-8 shadow-lg">
              <h3 className="text-lg font-semibold text-slate-900">Bergabunglah dengan Kami</h3>
              <p className="mt-4 text-sm text-slate-600">
                Daftar sebagai anggota dan nikmati fasilitas peminjaman.
              </p>
              <Link
                href="/register"
                className="mt-6 inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-500">
